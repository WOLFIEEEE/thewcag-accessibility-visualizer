# TheWCAG Accessibility Visualizer User's Guide

## Introduction

Thank you for your interest in TheWCAG Accessibility Visualizer.
TheWCAG Accessibility Visualizer is a browser extension that aims to visualize important but visually invisible information to improve the accessibility of web pages.
...
## What you can do with TheWCAG Accessibility Visualizer
...
The goal of TheWCAG Accessibility Visualizer is to visualize this information to eliminate these barriers and enable everyone to be aware of accessibility when coding or checking operation.

Note: TheWCAG Accessibility Visualizer **does not completely eliminate the need for verification with actual assistive technologies such as screen readers**. The information displayed by TheWCAG Accessibility Visualizer is supplementary and may cause you to miss critical issues. **We recommend combining screen reader verification** for incorporating into web development workflows.

## How to use TheWCAG Accessibility Visualizer

After installing TheWCAG Accessibility Visualizer, a TheWCAG Accessibility Visualizer item will appear in the extension menu.
If you use it frequently, we recommend pinning it to your browser's toolbar. When pinned to the toolbar, the TheWCAG Accessibility Visualizer icon will always be displayed.

![Screenshot of extensions menu open](./images/extensions_menu.png)

When you click the TheWCAG Accessibility Visualizer item in the extension menu or the TheWCAG Accessibility Visualizer icon pinned to the toolbar, the TheWCAG Accessibility Visualizer popup opens.

![Screenshot of TheWCAG Accessibility Visualizer popup opened](./images/a11y_visualizer_popup.png)
...
TheWCAG Accessibility Visualizer can be used alongside the following tools for more comprehensive accessibility verification:
