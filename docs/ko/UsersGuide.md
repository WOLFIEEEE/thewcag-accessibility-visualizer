# TheWCAG Accessibility Visualizer 사용자 가이드

## 소개

TheWCAG Accessibility Visualizer에 관심을 가져주셔서 감사합니다.
TheWCAG Accessibility Visualizer는 웹페이지의 접근성을 향상시키기 위해 중요하지만 시각적으로 보이지 않는 정보를 시각화하는 것을 목적으로 한 브라우저 확장 프로그램입니다.
...
## TheWCAG Accessibility Visualizer로 할 수 있는 것
...
이러한 정보를 시각화함으로써 이러한 장벽을 없애고, 누구나 코딩이나 동작 확인 시에 접근성을 의식할 수 있도록 하는 것이 TheWCAG Accessibility Visualizer의 목표입니다.

주의: TheWCAG Accessibility Visualizer는 **스크린 리더 등 실제 보조 기술에 의한 확인 작업을 완전히 불필요하게 만드는 것은 아닙니다**. TheWCAG Accessibility Visualizer가 표시하는 정보는 보조적인 것이며, 중대한 문제를 놓칠 가능성이 있습니다. 웹 개발 워크플로에 도입할 때는 **스크린 리더에 의한 확인을 병행하는 것을 권장합니다**.

## TheWCAG Accessibility Visualizer 사용법

TheWCAG Accessibility Visualizer를 설치하면 확장 프로그램 메뉴에 TheWCAG Accessibility Visualizer 항목이 나타납니다.
자주 사용하는 경우 브라우저 툴바에 고정 표시하는 것을 권장합니다. 툴바에 고정 표시하면 TheWCAG Accessibility Visualizer 아이콘이 항상 표시됩니다.

![확장 프로그램 메뉴를 열고 있는 상태의 스크린샷](./images/extensions_menu.png)

확장 프로그램 메뉴의 TheWCAG Accessibility Visualizer 항목 또는 툴바에 고정 표시된 TheWCAG Accessibility Visualizer 아이콘을 클릭하면 TheWCAG Accessibility Visualizer 팝업이 열립니다.

![TheWCAG Accessibility Visualizer 팝업을 열고 있는 스크린샷](./images/a11y_visualizer_popup.png)
...
TheWCAG Accessibility Visualizer는 다음 도구와 병용함으로써 더 포괄적인 접근성 검증이 가능합니다:

- [axe DevTools](https://www.deque.com/axe/devtools/)
- [WAVE](https://wave.webaim.org/)
- [Lighthouse](https://developer.chrome.com/docs/lighthouse/overview)

또한 이러한 도구를 사용한 검증에 더해 **실제 스크린 리더에 의한 확인**을 실시해야 합니다. TheWCAG Accessibility Visualizer는 개발 효율을 향상시키는 도구이지만, 실제 보조 기술에 의한 확인을 완전히 대체하는 것은 아닙니다.

## 크레딧 및 귀속

**TheWCAG Accessibility Visualizer**는 [ymrl](https://github.com/ymrl)이 만든 원본 [Accessibility Visualizer](https://github.com/ymrl/a11y-visualizer)를 기반으로 구축되었습니다. 훌륭한 기반을 만들고 MIT 라이선스 하에 공개해 주신 원작자에게 진심으로 감사드립니다.

### 원본 프로젝트
- **저장소**: [ymrl/a11y-visualizer](https://github.com/ymrl/a11y-visualizer)
- **작성자**: [ymrl](https://github.com/ymrl)
- **라이선스**: MIT 라이선스

### 이 프로젝트
- **프로젝트 이름**: TheWCAG Accessibility Visualizer
- **기반 프로젝트**: ymrl의 Accessibility Visualizer
- **라이선스**: MIT 라이선스
