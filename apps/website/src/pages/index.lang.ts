const dict = {
  ...
  guide: {
    title: "User Guide",
    description: "Learn how to use TheWCAG Accessibility Visualizer",
  ...
  tests: {
    title: "Test Pages",
    description:
      "We've prepared various implementation examples for you to verify TheWCAG Accessibility Visualizer's functionality",
