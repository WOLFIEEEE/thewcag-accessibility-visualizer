      ...
      <div className="flex flex-col gap-3 items-stretch">
        <div className="flex flex-col gap-2">
            ...
            {useTabsForElementTypes ? (
              ...
              <div className="px-2 py-1 bg-stone-100 dark:bg-stone-800 rounded-lg">
                <fieldset className="border-0 flex flex-col">
                  <legend
                    className={`text-xs ${disabled || !settings.accessibilityInfo ? "text-stone-500 dark:text-stone-400" : "text-coral-600 dark:text-coral-400"} font-bold mb-1`}
                  >
          ...
          <div className="flex flex-col gap-2 px-2">
            ...
            <Checkbox
              onChange={(e) => {
                handleChangeCheckbox("showSummaryPanel", e);
              }}
              checked={settings.showSummaryPanel}
              disabled={disabled}
            >
              <span className="text-sm">{t("summary.showPanel")}</span>
            </Checkbox>
            <label className="flex flex-row items-center justify-between gap-2">
              <span className="text-sm">{t("settings.displayMode")}</span>
              <select
                className="border-stone-300 dark:border-stone-600 border-solid border rounded-lg
                  py-1.5 px-2 text-xs
...
const DisplaySettingsSection = ({
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex flex-col gap-1 items-stretch px-2">
        ...
        <input
          ...
          className="accent-coral-500 dark:accent-coral-400 w-full h-2 bg-stone-200 dark:bg-stone-700 rounded-lg appearance-none cursor-pointer"
          type="range"
          min={0}
          max={100}
          step={1}
      ...
      <label className="flex flex-row gap-2 items-center justify-between px-2">
        ...
        <input
          className="border-stone-300 dark:border-stone-600 border-solid border rounded-lg
                py-1 px-2 text-sm text-right w-16 h-7
                bg-white dark:bg-stone-800
                text-stone-700 dark:text-stone-300
                focus:outline-none focus:ring-2 focus:ring-coral-500
                disabled:opacity-60
      ...
      <div className="px-2 py-2 bg-stone-100 dark:bg-stone-800 rounded-lg">
        <fieldset className="border-0 flex flex-col gap-2">
          <legend
            className={`text-xs ${disabled ? "text-stone-500 dark:text-stone-400" : "text-coral-600 dark:text-coral-400"} font-bold mb-1`}
          >
  ...
  return (
    ...
    >
      <summary className="cursor-pointer select-none text-sm font-bold text-coral-600 dark:text-coral-400 gap-1 mb-2 hover:text-coral-700 dark:hover:text-coral-300 transition-colors">
        {t("settings.displayCustomization")}
      </summary>
      {content}
    </details>
